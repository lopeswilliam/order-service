...
public class OrderController {
	...
	public ResponseEntity<OrderPedido> inclusao(@RequestBody OrderRequest depositoRequest) {
	...
	public ResponseEntity<OrderRequest> consulta(@RequestParam("order") String order) {
	...
	public ResponseEntity<List<OrderPedido>> consultaOrdens() {
		logger.info("Iniciando a consulta do OrderService");
